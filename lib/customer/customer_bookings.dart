  ...
  Widget buildRealServiceCard(Map<String, dynamic> service) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color(0xFF1A1A1A), // secondaryBlack from theme
        boxShadow: [
          BoxShadow(
        ...
        border: Border.all(
          color: const Color(0xFF404040), // mediumGray from theme
          width: 1,
        ),
      ),
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: const TextStyle(
              ...
              color: Color(0xFFFFFFFF), // primaryWhite
            ),
          ),
          const SizedBox(height: 8),
          Text(
            ...
            style: const TextStyle(
              color: Color(0xFFE0E0E0), // secondaryText
              fontSize: 14,
            ),
          ),
          ...
          Row(
            children: [
              const Icon(
                ...
                color: Color(0xFFFFD700), // goldAccent
                size: 18,
              ),
          ...
          Text(
            ...
            style: const TextStyle(
              fontSize: 13,
              color: Color(0xFFB0B0B0), // mutedText
            ),
          ),
          ...
          Align(
            ...
            child: ElevatedButton.icon(
              style: ElevatedButton.styleFrom(
                backgroundColor: const Color(0xFFFFD700), // goldAccent
                foregroundColor: const Color(0xFF000000), // primaryBlack
          ...
          Row(
            ...
            children: [
              ...
              TextButton.icon(
                ...
                icon: const Icon(
                  Icons.cancel,
                  color: Color(0xFFEF4444), // error color from theme
                ),
                label: const Text(
                  "Cancel",
                  style: TextStyle(
      ...
      children: [
        Container(
          ...
          child: TabBar(
            ...
            labelColor: const Color(0xFFFFD700), // goldAccent
            unselectedLabelColor: const Color(0xFFB0B0B0), // mutedText
            indicatorColor: const Color(0xFFFFD700), // goldAccent
            indicatorWeight: 3,
