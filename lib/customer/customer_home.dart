...
import 'customer_buy_sell.dart';
import 'customer_parts.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        child: const Icon(Icons.add, color: AppTheme.buttonPrimary, size: 28),
      ),
            ...
            child: Container(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle: TextStyle(color: AppTheme.primary, fontSize: 16),
                  prefixIcon: Icon(
                    Icons.search,
                    color: AppTheme.primary,
                    size: 22,
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(color: AppTheme.primary.withOpacity(0.07), blurRadius: 4),
          ],
        ),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 2),
                  Text(location, style: TextStyle(color: AppTheme.primary)),
                ],
              ),
            ),
          ],
