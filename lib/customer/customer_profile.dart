            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    'Version 1.0.0',
                    style: TextStyle(color: AppTheme.inputFill, fontSize: 14),
                  ),
      ...
      child: Column(
        children: [
          ...
          Text(
            ...
            style: const TextStyle(color: AppTheme.inputFill, fontSize: 16),
          ),
          const SizedBox(height: 4),
          Text(
            'Member since ${(_user['joinDate'] as DateTime?)?.year ?? DateTime.now().year}',
            style: const TextStyle(color: AppTheme.inputFill, fontSize: 14),
          ),
        ],
      ),
    );
        ...
        children: [
          ...
          Expanded(
            child: _buildStatCard(
              ...
              Icons.check_circle,
              const Color(0xFF10B981), // success color from theme
            ),
          ),
        ],
      ),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            title,
            style: TextStyle(fontSize: 12, color: AppTheme.inputFill),
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: AppTheme.primary,
            borderRadius: BorderRadius.circular(12),
            border: Border.all(color: AppTheme.buttonPrimary, width: 1.5),
          ),
          child: OutlinedButton.icon(
            onPressed: _addVehicle,
            icon: const Icon(Icons.add, color: AppTheme.buttonPrimary),
            label: const Text(
              'Add Vehicle',
              style: TextStyle(
                color: AppTheme.buttonPrimary,
